...
data['private_sale_long_gun'] = data['private_sale_long_gun'].replace(0,np.nan)
data['private_sale_long_gun'] = data['private_sale_long_gun'].fillna(data['private_sale_long_gun'].mean())
data['private_sale_handgun'] = data['private_sale_handgun'].replace(0,np.nan)
data['private_sale_handgun'] = data['private_sale_handgun'].fillna(data['private_sale_handgun'].mean())
data['private_sale_other'] = data['private_sale_other'].replace(0,np.nan)
data['private_sale_other'] = data['private_sale_other'].fillna(data['private_sale_other'].mean())
...
ax = plt.scatter(X_test['private_sale_long_gun_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['private_sale_long_gun_scaled'], Y_predict, marker='.', label='Предсказанные данные')
...
fig1 = plt.figure(figsize=(7, 5))
ax = plt.scatter(X_test['private_sale_long_gun_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['private_sale_long_gun_scaled'], Y_predict3, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('private_sale_long_gun_scaled')
plt.ylabel('suicides_no')
plt.plot(n_estimators_1)
...
ax = plt.scatter(X_test['private_sale_long_gun_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['private_sale_long_gun_scaled'], Y_grad_pred, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('private_sale_long_gun_scaled')
plt.ylabel('suicides_no')
...
fig1 = plt.figure(figsize=(7, 5))
ax = plt.scatter(X_test['private_sale_long_gun_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['private_sale_long_gun_scaled'], Y_grad_pred1, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('private_sale_long_gun_scaled')
plt.ylabel('suicides_no')
plt.plot(n_estimators_1)
...
plt.scatter(X_test['private_sale_long_gun_scaled'], Y_test, marker='s', label='Тестовая выборка')
plt.scatter(X_test['private_sale_long_gun_scaled'], lr_y_pred, marker='o', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('private_sale_long_gun_scaled')
plt.ylabel('suicides_no')
plt.show()
